...
Together with \key{tightness}, we have the useful route to prove weak convergence. 
...
\begin{thm}[Lindeberg's CLT]
    Let \(X_{n,m}\) be an independent \key{trianular array} satisfying the conditions:
    \begin{enumerate}
        \item 
    \end{enumerate} 
